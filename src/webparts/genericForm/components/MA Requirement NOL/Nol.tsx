...
import { INolRequirementProps, INolRequirementState } from './Nol.types';
...
export default class Nol extends React.Component<INolRequirementProps, INolRequirementState> {
    ...
    constructor(props: Readonly<INolRequirementProps>) {
        super(props);
        ...
        this.state = {
            ...
            isFormReady: false,
            errors: {},
            letter1SentDate: null,
            letter2SentDate: null,
            letter1Milestone: null,
            letter2Milestone: null,
            responseDate: null,
        ...
        this.config = Form.config.find((f) => f.type.toLowerCase() === FormType.MARequirementNol);
    ...
    private async init() {
        ...
        promises.push(this.initMarketChoices());
    ...
    public setInitialFormValues = async () => {
        ...
        const list = Form.config.find((f) => f.type.toLowerCase() === FormType.MARequirementNol).list;
        const listUrl = UrlHelper.getListWebRelativeUrl(pnpService.getUrl(), list);
        const selectedFields: string[] = [
            Consts.FIELDS.COMMON.TITLE,
            Consts.FIELDS.COMMON.CONTENTTYPE_ID,
        ...
        const responseSummary: string = item[Consts.FIELDS.MA_REQUIREMENT_NOL.RESPONSE_SUMMARY] || '';
    ...
    private initDatasheetTypeChoices = async (): Promise<void> => {
        ...
        const type: string = Consts.CONTENT_TYPES.MA_REQUIREMENT_NOL;
        const maRequirementBasicData = {
            ...this.state.maRequirementBasicData,
            typeChoices,
            type
    ...
    public render(): React.ReactElement<INolRequirementProps> {
        const {
            maRequirementBasicData,
            errors,
            isFormReady,
                        ...
                        <>
                            ...
                            {isFormReady &&
                                <form>
                                    ...
                                    {/* Date row */}
                                    {/* Letter 1 Sent Date and Letter 1 Milestone */}
                                        ...
                                        <div className="ms-Grid-row" >
                                            <div className="ms-Grid-col ms-sm6 ms-md6">
                                                <div className={styles.field}>
                                                    <div className={styles.fieldLabel}>
                                                        <div className={styles.fieldLabelContainer}>
                                                            <Label >{strings.FormMARequirementLetter1SentDateLabel}</Label>
                                                        </div>
                                                        <Tooltip content={strings.FormMARequirementTooltipLetter1SentDate} ></Tooltip>
                                                    </div>
                                                    <DatePicker
                                                        onSelectDate={this.onchangeLetter1SentDate}
                                                        value={letter1SentDate}
                                            ...
                                            <div className="ms-Grid-col ms-sm6 ms-md6">
                                                <div className={styles.field}>
                                                    <div className={styles.fieldLabel}>
                                                        <div className={styles.fieldLabelContainer}>
                                                            <Label >{strings.FormMARequirementLetter1MilestoneLabel}</Label>
                                                        </div>
                                                        <Tooltip content={strings.FormMARequirementTooltipLetter1Milestone} ></Tooltip>
                                                    </div>
                                                    <DatePicker
                                                        onSelectDate={this.onchangeLetter1MilestoneDate}
                                                        value={letter1Milestone}
                                                        formatDate={this.formatDate}
                                                        allowTextInput
                                                        styles={datepickerstyles}
                                                    />
                                    ...
                                    {/* Letter 2 Sent Date and Letter 2 Milestone */}
                                    <div className="ms-Grid" >
                                        <div className="ms-Grid-row" >
                                            <div className="ms-Grid-col ms-sm6 ms-md6">
                                                <div className={styles.field}>
                                                    <div className={styles.fieldLabel}>
                                                        <div className={styles.fieldLabelContainer}>
                                                            <Label >{strings.FormMARequirementLetter2SentDateLabel}</Label>
                                                        </div>
                                                        <Tooltip content={strings.FormMARequirementTooltipLetter2SentDate} ></Tooltip>
                                                    </div>
                                                    <DatePicker
                                                        onSelectDate={this.onchangeLetter2SentDate}
                                                        value={letter2SentDate}
                                                        formatDate={this.formatDate}
                                                        allowTextInput
                                                        styles={datepickerstyles} />
                                                </div>
                                            ...
                                            <div className="ms-Grid-col ms-sm6 ms-md6">
                                                <div className={styles.field}>
                                                    <div className={styles.fieldLabel}>
                                                        <div className={styles.fieldLabelContainer}>
                                                            <Label>{strings.FormMARequirementLetter2MilestoneLabel}</Label>
                                                        </div>
                                                        <Tooltip content={strings.FormMARequirementTooltipLetter2Milestone} ></Tooltip>
                                                    </div>
                                                    <DatePicker
                                                        onSelectDate={this.onchangeLetter2MilestoneDate}
                                                        value={letter2Milestone}
                                                        formatDate={this.formatDate}
                                                        allowTextInput
                                                        styles={datepickerstyles} />
                                                </div>
                                    ...
                                    <div className={styles.field}>
                                        <div className={styles.fieldLabel}>
                                            <div className={styles.fieldLabelContainer}>
                                                <Label>{strings.FormMARequirementResponseDateLabel}</Label>
                                            </div>
                                            <Tooltip content={strings.FormMARequirementTooltipResponseDate} ></Tooltip>
                                        </div>
                                        <DatePicker
                                            onSelectDate={this.onchangeResponseDate}
                                            value={responseDate}
                                            formatDate={this.formatDate}
                                            allowTextInput
                                            styles={datepickerstyles} />
                                    ...
                                    <div className={styles.field}>
                                        <div className={styles.fieldLabel}>
                                            <div className={styles.fieldLabelContainer}>
                                                <Label>{strings.FormMARequirementResponseSummaryLabel}</Label>
                                            </div>
                                            <Tooltip content={strings.FormMARequirementTooltipResponseSummary} ></Tooltip>
                                        </div>
                                        <RichText isEditMode={true} value={responseSummary} onChange={this.onChangeResponseSummary} />
                                    </div>
                                </form>
                            }
                        </>
    ...
    private onchangeLetter1MilestoneDate = (letter1Milestone: Date) => {
        this.setState({ letter1Milestone });
    };

    private onchangeLetter2MilestoneDate = (letter2Milestone: Date) => {
        this.setState({ letter2Milestone });
    };

    private onchangeLetter1SentDate = (letter1SentDate: Date) => {
        this.setState({ letter1SentDate });
    };

    private onchangeLetter2SentDate = (letter2SentDate: Date) => {
        this.setState({ letter2SentDate });
    };

    private onchangeResponseDate = (responseDate: Date) => {
        this.setState({ responseDate });
    };

    private onChangeResponseSummary = (responseSummary: string) => {
    ...
    private getFormSummary = () => {
        ...
        const responseSummaryText = DomHelper.cleanRichHtml(responseSummary);
        return (
            <div className={styles.summary}>
                ...
                <div className={styles.field}>
                    ...
                    <div className={styles.fieldValue}>
                        ...
                        {letter1SentDate ? this.formatDate(letter1SentDate) : ''}
                    </div>
                </div>
                <div className={styles.field}>
                    <div className={styles.fieldLabel}>
                    ...
                    <div className={styles.fieldValue}>
                        ...
                        {letter1Milestone ? this.formatDate(letter1Milestone) : ''}
                    </div>
                </div>
                <div className={styles.field}>
                    <div className={styles.fieldLabel}>
                    ...
                    <div className={styles.fieldValue}>
                        ...
                        {letter2SentDate ? this.formatDate(letter2SentDate) : ''}
                    </div>
                </div>
                <div className={styles.field}>
                    <div className={styles.fieldLabel}>
                    ...
                    <div className={styles.fieldValue}>
                        ...
                        {letter2Milestone ? this.formatDate(letter2Milestone) : ''}
                    </div>
                </div>
                <div className={styles.field}>
                    <div className={styles.fieldLabel}>
                    ...
                    <div className={styles.fieldValue}>
                        ...
                        {responseDate ? this.formatDate(responseDate) : ''}
                    </div>
                </div>
                <div className={styles.field}>
                    <div className={styles.fieldLabel}>
                    ...
                    <div className={styles.fieldValue}>
                        {responseSummaryText.length > 0 ? <RichText isEditMode={false} value={responseSummaryText} /> : ''}
                    </div>
                </div>
            </div >
        );
    ...
    private processCreation = async (): Promise<IItemAddResult> => {
        ...
        itemData[Consts.FIELDS.MA_REQUIREMENT_NOL.LETTER1_SENTDATE] = letter1SentDate?.toISOString();
        itemData[Consts.FIELDS.MA_REQUIREMENT_NOL.LETTER1_MILESTONE] = letter1Milestone?.toISOString();
        itemData[Consts.FIELDS.MA_REQUIREMENT_NOL.LETTER2_SENTDATE] = letter2SentDate?.toISOString();
        itemData[Consts.FIELDS.MA_REQUIREMENT_NOL.LETTER2_MILESTONE] = letter2Milestone?.toISOString();
        itemData[Consts.FIELDS.MA_REQUIREMENT_NOL.RESPONSE_DATE] = responseDate?.toISOString();
        itemData[Consts.FIELDS.MA_REQUIREMENT_NOL.RESPONSE_SUMMARY] = responseSummary;
        ...
        const parentFolderUrl = `${documentSpaceUrl}${Consts.DOCUMENT_SPACE.NOL_REQUIREMENTS_FOLDER_URL}`;
