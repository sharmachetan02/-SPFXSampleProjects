...
import { IAuthority } from '../../../../common/models/IBusiness';
...
export interface IAuthorityViewState {
  isViewReady: boolean;
  columns: IColumn[];
  viewItems: IAuthority[];
  filters: IFilter[];
  sort: ISort;
