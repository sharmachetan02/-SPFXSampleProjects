...
import { IEutelsatEntityViewProps, IEutelsatEntityViewState } from './EutelsatEntityView.types';
...
import { ICountry, IEutelsatEntity } from '../../../../common/models/IBusiness';
...
export default class EutelsatEntityView extends React.Component<
    IEutelsatEntityViewProps,
    IEutelsatEntityViewState
> {
    private config: IViewConfig;
    private allViewItems: IEutelsatEntity[] = [];
    constructor(props: Readonly<IEutelsatEntityViewProps>) {
        super(props);
        this.state = {
            isViewReady: false,
            columns: [],
        ...
        this.config = View.config.find((f) => f.type.toLowerCase() === ViewType.EutelsatEntity);
    }
    ...
    public async componentDidUpdate(prev: IEutelsatEntityViewProps) {
        if (
    ...
    private initColumns(): IColumn[] {
        const allColumns = [{
            key: 'Title',
            name: strings.EutelsatEntityViewTitleColumnLabel,
            fieldName: 'Title',
            minWidth: 300,
            maxWidth: 300,
            isResizable: true,
        ...
        {
            key: 'Country',
            name: strings.EutelsatEntityViewCountryColumnLabel,
            fieldName: 'Country',
            minWidth: 200,
            maxWidth: 200,
            isResizable: true,
        ...
        {
            key: 'Summary',
            name: strings.EutelsatEntityViewSummaryColumnLabel,
            fieldName: 'Summary',
            minWidth: 120,
            maxWidth: 120,
            isResizable: true
        ...
        {
            key: 'Status',
            name: strings.EutelsatEntityViewStatusColumnLabel,
            fieldName: 'Status',
            minWidth: 120,
            maxWidth: 120,
            isResizable: true,
    ...
    private initFilters = (): IFilter[] => {
        ...
        const searchFilter: IFilter = {
            ...
            fields: ['Title', 'Country', 'Status', 'Summary'],
            selectedValues: [],
            values: [],
        ...
        const countryFilter: IFilter = {
            name: 'Country',
            displayName: strings.EutelsatEntityViewCountryFilterLabel,
            placeHolder: strings.EutelsatEntityViewCountryFilterPlaceHolder,
            fields: ['Country'],
            selectedValues: [],
            values: [],
        ...
        const statusFilter: IFilter = {
            name: 'Status',
            displayName: strings.EutelsatEntityViewStatusFilterLabel,
            placeHolder: strings.EutelsatEntityViewStatusFilterPlaceHolder,
            fields: ['Status'],
            selectedValues: [],
            values: [],
            operatorBetweenValues: LogicalOperator.And,
        };
        allFilters = [searchFilter, countryFilter, statusFilter];
    ...
    public applyFilters = (): IEutelsatEntity[] => {
        const { filters } = this.state;
    ...
    private sort = (items) => {
        ...
        const key = sort.Property as keyof IEutelsatEntity;
                ...
                <span key={ct.Id} className={styles.termPill}>
                    <span className={styles.termPillText}>
                        <a
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                const url = `${Config.SITE.ROOT_WEB_URL}/${Consts.Pages.DATASHEET_URL}?config=${encodeURIComponent(ViewType.Country)}&itemId=${ct.Id}`;
    ...
    public render(): React.ReactElement<IEutelsatEntityViewProps> {
