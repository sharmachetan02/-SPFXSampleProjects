declare interface IDateTimeStrings {
  ...
  L_RelativeDateTime_AboutAnHourFuture: string;8
...
declare interface IRichTextStrings {
  ...
  PicturePickerCancelButtonLabel: string;
...
declare module 'RichTextStrings' {
  const strings: IRichTextStrings;
  export = strings;
}
