...
({
  ...
  PicturePickerCancelButtonLabel: 'Cancel',
  ...
  PicturePickerHeader: 'File Picker',
  ...
  ListItemCommentsLabel: 'Email Body',
  ListItemCommentsNoCommentsLabel: 'There is no Email Body',
