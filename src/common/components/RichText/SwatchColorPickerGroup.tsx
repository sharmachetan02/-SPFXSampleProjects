...
import { ISwatchColorPickerGroupProps, ISwatchColor } from './SwatchColorPickerGroup.types';
...
export default class SwatchColorPickerGroup extends React.Component<ISwatchColorPickerGroupProps> {
