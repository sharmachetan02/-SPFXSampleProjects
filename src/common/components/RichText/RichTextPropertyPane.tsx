...
import { ThemeColorHelper } from '../../../common/helpers/ThemeColorHelper';
...
export default class RichTextPropertyPane extends React.Component<IRichTextPropertyPaneProps, IRichTextPropertyPaneState> {
   ...
   * @param prevState
   */
  public componentDidUpdate(prevProps: IRichTextPropertyPaneProps): void {
   ...
   */
  public onChangeSelection = (range: RangeStatic): void => {
    const quill = this.props.editor;
